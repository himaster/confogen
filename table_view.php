		...
		<TABLE class="table table-striped table-condensed" id="newtable">
			<TR class="active">
				...
				<TD><INPUT type="text" id="project" Value="" style="width: 20px"></TD>
				<TD><INPUT type="text" id="lang" Value="" style="width: 20px"></TD>
			...
			while ($project = mysql_fetch_array($projects)) {
				...
				while ($row = mysql_fetch_assoc($result)) { ?>
					<TR>
						...
						<TD><INPUT id="project_<?php echo $row['project']; ?>" type='text' ondblclick="textSelector( this ); return false;" readonly value="<?php echo $row['project']; ?>" style="width: 20px"></TD>
						<TD><INPUT id="lang_<?php echo $row['lang']; ?>" type='text' ondblclick="textSelector( this ); return false;" readonly value="<?php echo $row['lang']; ?>" style="width: 20px"></TD>
